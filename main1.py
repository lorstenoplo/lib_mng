...
title = Label(entries_frame, text="library Management System", font=("Calibri", 18, "bold"), bg="#000000", fg="white")
title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

lblName = Label(entries_frame, text="Name of the book", font=("Calibri", 16), bg="#000000", fg="white")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("Calibri", 16), width=30)
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")

lblAge = Label(entries_frame, text="Author", font=("Calibri", 16), bg="#000000", fg="white")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16), width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="D.O.P", font=("Calibri", 16), bg="#000000", fg="white")
...
lblGender = Label(entries_frame, text="Genre", font=("Calibri", 16), bg="#000000", fg="white")
lblGender.grid(row=3, column=0, padx=10, pady=10, sticky="w")
comboGender = ttk.Combobox(entries_frame, font=("Calibri", 16), width=28, textvariable=gender, state="readonly")
comboGender['values'] = ("Action", "Action","Sci-Fi","Supernatural","Romance","Psychological","Mystery","Magic","Comedy","Horror","Drama","Fantasy")
comboGender.grid(row=3, column=1, padx=10, sticky="w")

lblContact = Label(entries_frame, text="Date Borrowed", font=("Calibri", 16), bg="#000000", fg="white")
...
lblAddress = Label(entries_frame, text="Description", font=("Calibri", 16), bg="#000000", fg="white")
...
tree_frame.place(x=0, y=520, width=1980, height=480)
style = ttk.Style()
